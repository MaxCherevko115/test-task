...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <form action="{{route('admin.store')}}" method="POST" class="col-md-12" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="file" name="img" class="form-control-file" id="exampleImage1" aria-describedby="imageError">
                <div id="imageError" class="form-text text-danger">@error('img'){{$message}}@enderror</div>
            </div>
